const HomePage: React.FC = () => {
  return (
    <div className="flex h-full justify-center items-center dark:bg-slate-800">
      <div className="mx-auto mt-10 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
        <div className="text-center ">
          ...
          <p className="mx-auto mt-3 max-w-xl text-lg text-gray-500 dark:text-slate-400 sm:mt-5 md:mt-5">
            Quizloom is the AI-powered quiz generator that helps you and your
            team quickly create engaging, custom quizzes across multiple formats
            10X faster. Whether for education, training, or fun, it streamlines
            the process to deliver high-quality quizzes with ease.
          </p>
